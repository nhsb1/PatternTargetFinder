...
=====================================================
PatternTargetFinder calculates the target price for an equity based on the high (-rh), and low (-rl) that you pass to it from the shell.  You can specify an init price, Outputting to the command line and clipboard.
